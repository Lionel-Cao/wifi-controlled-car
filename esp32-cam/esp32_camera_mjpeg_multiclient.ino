/*
  ...
  Compile as:
   ...
   PSRAM: Enabled
*/
//#define BLYNK_PRINT Serial //this is for blynk testing
...
//#include <BlynkSimpleEsp32.h> //this is for blynk testing, don't config
...
//char auth[] = "YFaC0gE3BiAZY4BscN6gtsU1PCLvMwNQ";
//char ssid[] = "";
//char pass[] = "";
...
void setup()
{
  ...
  //Blynk.begin(auth, ssid, pass, IPAddress(192,168,1,125), 8181); //don't config
